...
const services = [
    ...
    { id: 1, name: 'TikTok Combo Offer 🥳(1000)', price: 140, min: 1000, max: 10000, desc: '700 views+150 likes+100 followers+10 emoji comments+10 custom comments+30 random comments ye sirf 1k k order k liye hai 5k k liye ye sab 5x hoga-- Fast Speed -- Complete In 24 hours -- Guarenty Bilkul Bhi Ni Hai Khatam Ya Kam Bhi Ho Sakte Hain-' },
    ...
    { id: 3, name: 'TikTok Likes Lifetime Guarantee(1000)', price: 210, min: 100, max: 500000, desc: 'Best Likes Start in 0-5 minutes -- Fast Speed -- Complete In 30 minutes to 3hours -- Guarenty Puri zindagi ki hai kabhi kam hon ussi waqat wapis pure karwao waise to zida tar kam hote he ni hain-' },
    ...
    { id: 10, name: 'Facebook Followers Lifetime Guarantee (1000)', price: 150, min: 100, max: 30000, desc: 'Best Facebook Followers (Working in current update) |Max 100k| HQ Profiles--Day 20k-- Fast Speed -- Complete Hone ka koi filhal Time ni hai -- Guarenty Puri Zindagi ki hai ager kam ho jayen to dubara complete karwa sakte ho-' },
...
app.get('/', (req, res) => {
    res.send(`
        ...
        <body>
            <div class="container">
                <h2>Power Of M.Madni Ansari---Read Order Discription Carefully Before Order</h2>
                <div class="notice">
